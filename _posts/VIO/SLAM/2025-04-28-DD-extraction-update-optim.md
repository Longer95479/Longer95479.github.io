...
![HongKongWorld](/assets/2025-04-28-DD-extraction-update-optim/hongkongworld.png)
...
从集合或可行域的角度思考，水平主方向给出一个 *水平圆圈* 的集合，而某个法向量可以给出一个有一定厚度的垂直于该法向量的 *圆环*，我们要求解的则是 **水平圆圈与圆环的交集**。
