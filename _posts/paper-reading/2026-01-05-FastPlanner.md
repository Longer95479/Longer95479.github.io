...
- 控制点 $p_i$ 影响 $t \in[t_i, t_{i+k+1}]$
- $[t_l, t_{l+1}]$ 受 $p_{l-k}, p_{l-k+1}, p_{l-k+2}, \cdots, p_l$ 影响

[CAGD 学习笔记 | 样条 - Ne0](https://ne0.io/posts/1534275948/#de-boor-%E7%AE%97%E6%B3%95)
